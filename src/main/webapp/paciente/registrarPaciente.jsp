				        ...
				        <div class="row">
				            <div class="col-md-6">
				                ...
				                <div class="form-group">
				                    ...
				                    <input type="text" class="form-control" id="txtPrimerApe" name="txtPrimerApe" required>
				                </div>
				                
				                <br>
				                <div class="form-group">
				                    <label for="txtSegundoApe">2° Apellido</label>
				                    <input type="text" class="form-control" id="txtSegundoApe" name="txtSegundoApe" required>
				                </div>
				                <br>
				                <div class="form-group">
